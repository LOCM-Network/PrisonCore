...
public class RankStorage {
	...
	public static Rank O = new Rank("&lSao &dBăng", 15, 100000, false, false);
	...
	public static Rank S = new Rank("&l&4Thần &6Thoại", 19, 5000000, false, false);
	public static Rank T = new Rank("&l&aSử Thi", 20, 10000000, false, false);
	public static Rank U = new Rank("&l&6Chiến &eThần", 21, 15000000, false, false);
	public static Rank V = new Rank("&l&eSiêu Thần", 22, 20000000, false, false);
